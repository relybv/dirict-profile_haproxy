...
# This script installs puppet 3.x and deploy the manifest using puppet apply -e "include profile_haproxy"
# Usage:
# <powershell>
# Set-ExecutionPolicy Unrestricted -Force
# icm $executioncontext.InvokeCommand.NewScriptBlock((New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/relybv/profile_haproxy/master/files/bootme.ps1')) -ArgumentList ("profile_haproxy")
#</powershell>


  param(
    [string]$role = "profile_haproxy",
  )

  $puppet_source = "https://github.com/relybv/dirict-profile_haproxy.git"
